...
1) reflect what is happening on the ground,</br>
2) protect the right people, and</br>
3) will support outcomes that stymie the perpetual exploitation of marginalized groups. </br>
...
To say that Louisiana is a hot spot for EJ issues is an understatement. Zooming into [this map](http://ejatlas.org/) from EJAtlas.org, it’s easy to see why these conversations are so important here. 

[![screen_shot_EJ.png](https://i.publiclab.org/system/images/photos/000/011/592/medium/screen_shot_EJ.png)](https://i.publiclab.org/system/images/photos/000/011/592/original/screen_shot_EJ.png)

_Disclaimer: the information on this map depends on the information the group receives from partners and collaborators._
...
In a webinar on the EPA Federal Interagency Agency Working Group  (EJ IWG), there was discussion on Title VI, and [Executive Order 12898](http://www2.epa.gov/laws-regulations/summary-executive-order-12898-federal-actions-address-environmental-justice), yet when faced with the question “Is there anything that dictates that states must recognize EJ issues in their policy?” The answer is: “well it’s different state to state.” 
