...
path: public/static/notes/stevie/08-06-2019/seeking-community-fellow-for-oil-gas-water-fellowship-trio.md
uid: 422561
...
**Where: Applicants interested in this Fellowship must be embedded (from, living in, or working in) a community with oil & gas industry impacts on water.** Preference will be given to applicants from Gulf Coast states, particularly Louisiana.
...
This Fellowship is part of the [Oil & Gas Water Fellows Trio](https://publiclab.org/wiki/fellows) and is an opportunity for an individual embedded in a community with oil & gas industry impacts to work with Public Lab on local water quality concerns related to the industry.
...
2.) To document their user experience with current and emerging monitoring tools available at [PublicLab.org](http://PublicLab.org),

3.) To work in collaboration with the Hardware and Monitoring Methods Fellows to draft and compile materials for a "Research Area Review" on water quality monitoring on [PublicLab.org](http://PublicLab.org).
...
- Use and explore tools and methods shared on [PublicLab.org](http://PublicLab.org) for water monitoring.
- Create documentation on [PublicLab.org](http://PublicLab.org) on your experience using different tools and methods, and provide feedback for how these resources can be used by yourself and others.
