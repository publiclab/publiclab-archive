...
- If you have an activity [post it here][1].
- If you have resources, you can drop them in on [this page where][2] we're organizing materials. 

  [1]: https://publiclab.org/post?tags=activity:FunCom,FunCom,seeks:replications&title=How%20to%20do%20X
  [2]: https://publiclab.org/wiki/barnraising-host#FunCom+resources+and+activities