...
path: public/static/notes/xose/12-06-2016/afloss-collection-of-tutorials.md
uid: 497123
...
Compose a list of tutorials and videotutorials to the main Audiovisual editing Free Libre Open Source Software to facilitate the post-production of investigative materials using free/libre tools.
It also includes a list of sites withe free downloadeable multimedia archives.
The main purpose is to collect info in a single list of browser bookmarks.

##My attempt and results

At the present moment the collection includes tutorials of this aplications:

**[Kdenlive](http://www.kdenlive.org/) - [Natron](http://natron.fr/) - [Openshot](http://openshot.org/) - [Lightworks](https://www.lwks.com/) - [Aegisub](http://aegisub.org/) - [Audacity](http://www.audacityteam.org/) - [Ardour](http://ardour.org/) - [ImageJ](https://fiji.sc) - [Gimp](http://www.gimp.org/) - [Darktable](www.darktable.org/) - [Inkscape](https://inkscape.org/) - [Scribus](http://scribus.net/) - [Obscuracam](https://guardianproject.info/apps/obscuracam/)**

##Using the collection

1. download the file [**ESCUELA.zip**](https://archive.org/download/escuelaaudiovisualFLOSS_1_201612/ESCUELA.zip)
2. unzip the file ESCUELA.zip
