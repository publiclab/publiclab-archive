...
Develop a tool with Drone (Quadcopter), InfraRed camera, in forestry theme

###My attempt and results

want to discriminate trees (species, size, age)

###Questions and next steps

why shadows have informations like chlorophyllian activity? 
