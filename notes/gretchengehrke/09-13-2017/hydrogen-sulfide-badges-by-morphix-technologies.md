...
path: public/static/notes/gretchengehrke/09-13-2017/hydrogen-sulfide-badges-by-morphix-technologies.md
uid: 430549
...
The product information sheet can be found here: https://www.morphtec.com/file/image/382015-SafeAirH2S-021117.pdf, and the patent for the general concept of the badge can be found here: https://www.google.com/patents/US6284198. The product information sheet and patent don't disclose the chemicals that are reacting with hydrogen sulfide to produce the color change, so it's not easy to discern if there are likely interferences or co-contaminants (the product info sheet says there aren't any known interferences, but without explicit info about what has been tested, I wouldn't want to take that at face value). That said, they are used in industrial settings and have a low enough detection limit that they are useful at health-relevant warning levels (see the Acute Exposure Guideline Levels here: https://www.epa.gov/sites/production/files/2014-11/documents/hydrogen_sulfide_final_volume9_2010.pdf). 

We're thinking about using these badges alongside a couple of DIY hydrogen sulfide detection methods, including a silver halide photopaper method (https://publiclab.org/wiki/hydrogen-sulfide-sensor) and an elemental copper rod method (https://publiclab.org/notes/sharon-wilson/3-21-2012/copper-rod-test-h2s). Has anyone used these Morphix Technologies badges before, or something similar. They cost $160.65 for a pack of 50 (and have a shelf life of 2 years), so they could be a fairly readily available option. Please comment below if you have used them or something like them, or know what chemicals they use! 