...
This Monitoring Methods Fellowship is part of the [Oil & Gas Water Fellows Trio](https://publiclab.org/wiki/fellows) and is an opportunity to research and document water monitoring methods used by people to collect evidence on the environmental impacts of the oil & gas industry. I'll be specifically focusing on:
...
- Connecting with individuals who do this type of monitoring, conduct interviews, and document their stories and experiences related to this work on [PublicLab.org](http://PublicLab.org).
- Collaborating with the Hardware and Community Fellows (Will and Rollin, respectively) to draft and compile materials for a "Research Area Review" on water quality monitoring on [PublicLab.org](http://PublicLab.org).

## I'd Love Your Help!

- Will's already gotten a great start with [**introducing some questions**](https://publiclab.org/notes/wmacfarl/09-18-2019/oil-and-gas-hardware-fellow-introduction) that are central to our research and roles as fellows: [Why do individuals/organizations want to collect water quality data](https://publiclab.org/questions/wmacfarl/09-18-2019/why-do-individuals-organizations-want-to-collect-water-quality-data)? And [How can DIY/community-collected environmental data be used](https://publiclab.org/questions/wmacfarl/09-18-2019/how-can-diy-community-collected-environmental-data-be-used "https://publiclab.org/questions/wmacfarl/09-18-2019/how-can-diy-community-collected-environmental-data-be-used")? We'll be posting more questions throughout the fellowship, so follow the water-quality and oil-and-gas tags to keep up with the discussions!
