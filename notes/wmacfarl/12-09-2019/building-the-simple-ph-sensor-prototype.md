...
path: public/static/notes/wmacfarl/12-09-2019/building-the-simple-ph-sensor-prototype.md
uid: 424597
...
To select the pH sensor, we will connect a jumper wire from Pin 3 to Pin 5 on our Arduino.
