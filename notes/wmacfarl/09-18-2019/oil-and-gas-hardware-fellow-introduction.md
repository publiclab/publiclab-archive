...
As part of the fellowship onboarding process I was given a set of useful [background reading](https://docs.google.com/document/d/1vhc5yT0VYRQQD3DPQ047LlRahrUZ-3rtxIv-dvQmiKI/edit#) on water quality monitoring and oil and gas pollution.

I found [An Introduction to Community Based Water Monitoring ](https://www.fractracker.org/projects/water-monitor/intro/)from the [Knowing Our Water Project](https://www.fractracker.org/projects/water-monitor/) and [Making the Most of Air Monitoring](https://static1.squarespace.com/static/581b7ec43e00bed6261bc168/t/5b3501ebaa4a99619d9a6fe8/1530200555982/Making+the+Most+of+Air+Monitoring+Report.pdf "https://static1.squarespace.com/static/581b7ec43e00bed6261bc168/t/5b3501ebaa4a99619d9a6fe8/1530200555982/Making+the+Most+of+Air+Monitoring+Report.pdf") from the [Fair Tech Collective](https://www.fairtechcollective.org/) to be particularly helpful in clarifying some of my thoughts and giving some insight into how data collection can be made useful to communities, environmentalists, and activists as well as provoking. This reading also helped me formulate some more concrete questions about how we want to approach DIY monitoring tools and hardware as part of this fellowship and beyond.
...
**[1) Why do we want to collect water quality data?](https://publiclab.org/questions/wmacfarl/09-18-2019/why-do-individuals-organizations-want-to-collect-water-quality-data)**
...
**[2) Are there uses for environmental data for which DIY and community data-collection are well-suited?](https://publiclab.org/questions/wmacfarl/09-18-2019/how-can-diy-community-collected-environmental-data-be-used)**
...
From [An Introduction to Community Based Water Monitoring](https://www.fractracker.org/projects/water-monitor/intro/) --
...
The Knowing Our Waters project has also produced [A Guide to Water Monitoring Protocols](https://www.fractracker.org/projects/water-monitor/monitoring-protocols/ "https://www.fractracker.org/projects/water-monitor/monitoring-protocols/") which I have not yet read deeply.
...
The [KnowFlow](https://publiclab.org/wiki/knowflow) -- "KnowFlow is designed for environmental activists who wants to monitor water quality and get real time data. Now it can monitor 5 parameters: Temperature, pH, ORP, Electronic conductivities, Dissolved Oxygen."

and the [Riffle](https://publiclab.org/wiki/riffle) -- "The Riffle is a collection of designs that take an open source approach to water monitoring, with the intent of making gathering water information easier and more accessible. "