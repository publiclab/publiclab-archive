...
path: public/static/notes/Anavela/10-22-2020/outreachy-proposal-comment-editor-overhaul-project.md
uid: 725718
...
[GitHub](https://github.com/ana-vela)

[Twitter](https://twitter.com/anaveecodes "https://twitter.com/anaveecodes")
...
**_A general sense of the architecture of the project:_**
...
**[Comment Editor Overhaul Project](https://pad.publiclab.org/p/outreachy)**

_2\. Create a tagging system for this project to identify associated issues on GitHub_
...
For this project, I will need to consult the [Public Lab Editing Suite: Posting Features Inventory Draft](https://docs.google.com/document/d/1hOqa4tC0jqEuSaur1zKMtnxnknkARui3HTKqO3AUFMA/edit) which includes what tasks need to be completed. I will also need to meet with mentors and other contributors who are familiar with this project.

---------

# **First-time contribution**

Merged PR: [My current contribution to the project](https://github.com/publiclab/plots2/issues/6598)
...
I have been helping maintain this [open source project](https://github.com/Syknapse/Contribute-To-This-Project) on Github.
...
I also am working with another developer on a [React project](https://github.com/ana-vela/translator-app). We meet weekly to talk about our progress and divide the work to get the app moving forward. The project is a simple translator app. We are completing this to improve our React skills and gain experience working with a dev partner.
