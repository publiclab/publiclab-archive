...
> Write programs that do one thing and do it well. Write programs to work together. Write programs to handle text streams, because that is a universal interface -- [[Doug McIlroy, creator of the Unix Pipe]](http://en.wikipedia.org/wiki/Unix_philosophy#Doug_McIlroy_on_Unix_programming)

__The PublicLab.org Markdown parser had some issues with this post so for now I have moved it to a gist on Github. Read it [here](https://gist.github.com/rjsteinert/f3823f3cdc9971779c17) but I'd love to see your comments below.__
