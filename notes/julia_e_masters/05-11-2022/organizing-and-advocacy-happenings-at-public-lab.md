...
- -><-Dr. Bethany Wiggin presented on _Futures Beyond Refining_, a campus-community partnership that used stories and oral histories to address environmental data poverty in South Philadelphia, the site of a catastrophic explosion of a petroleum refinery.  
[Presentation: Futures Beyond Refining](https://docs.google.com/presentation/d/1Uk1fJ-J14I9j4AhmZf3oM7fewH-sISN8/edit?usp=sharing&ouid=117659892943869436894&rtpof=true&sd=true)
...
[Presentation: Pb. Lead in South East LA](https://docs.google.com/presentation/d/161QTfk6xTunWjtg8RbAXKmYUDfncR4hJGaVl3UWMI0s/edit?usp=sharing)
...
That's why, in the coming months, this team will be collaborating with colleagues at EarthJustice to create a Reporting Guide. The guide will include a list of the names, AI numbers, and exact locations, of every plant in St. James parish, to help residents identify which plant may be causing a particular odor and provide as much information as possible to DEQ. It will use insights from the Louisiana Environmental Action Network's [Citizen's Guide](https://leanweb.org/citizens-guide) and Tulane Environmental Law Clinic's [Citizen's Guide](http://www2.tulane.edu/~telc/html/CG_Vids.html "http://www2.tulane.edu/~telc/html/CG_Vids.html") to streamline explanations of different reporting mechanisms. Learn more about the origins of the project [here](https://publiclab.org/tag/game-over-formosa), and to follow the project's ongoing work, follow the tag [#formosaplastics](/profile/formosaplastics "https://publiclab.org/profile/formosaplastics").
