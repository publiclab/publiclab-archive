...
En cuanto a las botellas, se observo que la textura es importante porque de eso depende la facilidad para trabajarlas como protectores de cámaras. La posibilidad de otros materiales es cierta pues solo se necesita proteger a la cámara de los golpes.

El grupo tuvo preguntas al respecto de los otros materiales utilizados (las cuerdas, la estructura de la cometa) y se propuso los potenciales materiales alternativos que se puedan encontrar en cada ciudad donde se haga este tipo de experimento.

Lo decepcionante en este caso fue que las cámaras no funcionaron, por lo que se debe investigar cuales fueron los factores (en cada cámara utilizada) que impidieron que se completara el experimento.
