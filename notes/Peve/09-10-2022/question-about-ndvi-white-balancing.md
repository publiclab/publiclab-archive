...
When I am using custom white balance setting in camera, do I have to  
use  
with or without red or blue filter, when  
I am doing it?  
  
I currently use without those filters, with red or blue coloured  
cardboard paper. (I think results were close to those examples at  
your  
page)  
