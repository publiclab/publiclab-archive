...
path: public/static/notes/shannon/3-7-2013/spectral-challenge-press-release.md
uid: 9
...
NEW ORLEANS, LA— Starting today, makers, hackers and do-it-yourselfers worldwide are invited to join the [Spectral Challenge](http://spectralchallenge.org/), offering crowd-funded prizes to teams that tackle real-world environmental problems with low-cost, open source spectrometry. 
...
Information on entering the Challenge or contributing to the prize pool can be found at: http://spectralchallenge.org/
For updates, follow @PublicLab and #spectralchallenge on Twitter.
...
###Contacts
Public Laboratory for Open Technology and Science: Jeffrey Warren, Director of Research; phone: 415.508.6769; email: jeff@publiclaboratory.org or Shannon Dosemagen, Director of Outreach and Partnerships; phone: 504.239.4642; email: shannon@publiclaboratory.org