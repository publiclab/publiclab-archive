...
path: public/static/notes/Sara/07-21-2013/digital-sts-workshop-at-arnold-arboretum-in-boston.md
uid: 8
...
I was invited to mentor a group of STS researchers in developing a [Digital STS workshop](http://digitalsts.wordpress.com/2013/06/12/constructing-data-narratives-at-the-codesign-workshop/) at the [Arnold Arboretum](http://www.arboretum.harvard.edu/). The workshop, co-hosted by [Metalab](http://metalab.harvard.edu/) at Harvard, was fantastic, the arboretum staff gave us tours of both the grounds and their digital archive and expressed an interest in trying to extend public engagement with the arboretum. Members of the group were:
...
With the goal of extending public engagement with the arboretum in mind, balloon mapping seemed like a perfect project and I'd been looking for a chance to try out Public Lab's new Infragram. With the help of [cfastie](http://publiclab.org/profile/cfastie), who sent a Rosco #2007 filter my way, I made a Super Blue camera following Jeff Warren's super helpful [video](http://publiclab.org/wiki/near-infrared-camera-history). I went with taping a Rosco Blue Filter over the lense so it is removeable. Making the camera took two tries (subject of a research note to come). 
...
<iframe width="420" height="315" src="//www.youtube.com/embed/B9g4WaICTdA" frameborder="0" allowfullscreen></iframe>

<iframe width="420" height="315" src="//www.youtube.com/embed/rRDX9Db3hp4" frameborder="0" allowfullscreen></iframe>
...
[Visible Light Map](https://mapknitter.org/map/view/digitalstsarnoldarboretummapnir)

[Near Infrared Map](https://mapknitter.org/map/view/digitalstsarnoldarboretummapnir2)
