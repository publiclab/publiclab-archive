...
- mounting pole
- ratchet straps
- PM sampling [Field Data Log](https://publiclab.org/wiki/minivol#how+is+the+MiniVol+used?)
- [MiniVol Manual](https://publiclab.org/wiki/minivol#how+is+the+MiniVol+used?)
- Disposable gloves

as well as: _prepared 45mm filters in cassettes OR_

- 47mm filters
- empty cassettes
- cassette separator
- PTFE-coated forceps![image description](https://publiclab.org/system/images/photos/000/019/490/large/20170207_161119_crop.png "20170207_161119_crop.png")![image description](https://publiclab.org/system/images/photos/000/020/085/large/20170404_163944_deployment_sheet.jpg "20170404_163944_deployment_sheet.jpg")

## MiniVol Pre-deployment Setup:

#### Check that the battery is charged and charge if needed

The battery is best stored partially charged, but should be fully charged before deployment. Press the "test" button to check:

![image description](https://publiclab.org/system/images/photos/000/019/491/large/20170207_161211.png "20170207_161211.png")

#### Check for leaks

The pump needs a leak check to make sure nothing was damaged in transit.

1. Insert the battery, aligned to the indicator.
2. Remove the impactor/filter holder from the inlet tube, if its attached.
3. orient the MiniVol so it is vertical, with the inlet up top.
4. Unscrew the inlet tube compression fitting, pull the inlet tube all the way out, and tighten the compression fitting.

[![IMG_20170203_151731.png](https://publiclab.org/system/images/photos/000/019/447/large/IMG_20170203_151731.png)](https://publiclab.org/system/images/photos/000/019/447/original/IMG_20170203_151731.png)5\. Turn the pump on by pressing the ON/AUTO/OFF button on the timer until a bar on the lower edge of the display is above "ON." The pump will start and the power indicator LED will light up.

[![20170206_171659.png](https://publiclab.org/system/images/photos/000/019/448/large/20170206_171659.png)](https://publiclab.org/system/images/photos/000/019/448/original/20170206_171659.png)6\. Cover the air inlet tube with the palm of your hand.

7\. The ball in rotameter (flow gauge) should drop to zero and should not be moving at all.

[![rotameter-to-zero.png](https://publiclab.org/system/images/photos/000/019/450/large/rotameter-to-zero.png)](https://publiclab.org/system/images/photos/000/019/450/original/rotameter-to-zero.png)

8\. If the rotameter reads zero, turn the sampler off by pressing the ON/AUTO/OFF button on the timer until the bar on the lower edge of the display is above the "OFF."

9\. If the rotameter does not read zero, proceed to ["Troubleshooting leaks."](/notes/mathew/03-26-2017/troubleshooting-leaks-on-the-minivol)
...
While it is recommended to use the timer, the MiniVol can be deployed without programming the timer. Turned off and on at exactly a 24 hour indicator by setting the ON/AUTO/OFF button to ON and OFF. Do not set the timer to AUTO.
...
1. Set the day. Hold down the CLOCK button while pressing the WEEK button until the correct day appears on the top of the display ![image description](https://publiclab.org/system/images/photos/000/019/495/large/20170207_170957.png "20170207_170957.png")
...
1. Press the PROG button once to enter programming mode. 1ON will appear near the lower left corner of the display to indicate that you are setting the 1st turn-on time.
2. Use the HOUR and MIN buttons to enter the power-on time for the monitoring period.
3. Use the WEEK button to select the day of the monitoring period. "Mo Tue We Th Fr Sa Su" indicates that the monitor will run every day. Continue pressing the WEEK button until only the day of the monitoring period is selected.
4. Press the PROG button to move to setting the power-off time. 1OFF will appear near the lower left corner of the display to indicate that you are setting the 1st turn-off time.
5. Use the HOUR and MIN buttons to enter a power-off time identical to the power-on time.
6. Use the WEEK button to select _the day after_ the power-on time.
...
![setting start time off](https://publiclab.org/system/images/photos/000/019/498/large/20170207_171401.png "20170207_171401.png") ![Setting time ON](https://publiclab.org/system/images/photos/000/019/497/large/20170207_171359.png "20170207_171359.png")
...
Using the Flow Calculator tab of the \[MiniVol spreadsheet specific to your MiniVol's Serial Number\]([https://publiclab.org/wiki/minivol#Lending](https://publiclab.org/wiki/minivol#Lending)), enter:
...
![image description](https://publiclab.org/system/images/photos/000/019/499/large/Screen_Shot_2017-02-08_at_5.10.18_PM.png "Screen_Shot_2017-02-08_at_5.10.18_PM.png")
...
- Minivol impactor assemblies

Filter Handling Guidelines:

- Perform indoors in a clean space.
- Only touch filters by their edges and only with the PTFE (teflon)-tipped forceps.
- Never bend or fold filters.
- Always store filters in their included petrislides covers.
- Do not leave petrislide covers open-- Close as soon as possible.

Steps to Loading the Cassette:

1\. Open the cassette with the Cassette Separator

![image description](https://publiclab.org/system/images/photos/000/020/087/large/20170326_165526_filter_gif_crop_big.gif "20170326_165526_filter_gif_crop_big.gif")

2\. Select a filter and remove it from its petrislide cover. Using the forceps to lift the filter from its edge. Move the filter into the cassette.

![image description](https://publiclab.org/system/images/photos/000/020/088/large/20170326_165526_filter-close_gif_crop_big2.gif "20170326_165526_filter-close_gif_crop_big2.gif")

3\. place the filter cassette in the filter holder. (_PM2.5 configuration shown. For PM10, see "installing filter cassette in impactor" below._)

![image description](https://publiclab.org/system/images/photos/000/020/089/large/IMG_20170404_161403_filter-impactor_gif.gif "IMG_20170404_161403_filter-impactor_gif.gif")

4\. place an identifying tag on the filter holder so the id of the mounted filter is known.

![image description](https://publiclab.org/system/images/photos/000/020/090/large/20170326_165526_impactor-label_gif_crop_big.gif "20170326_165526_impactor-label_gif_crop_big.gif")
...
![image description](https://publiclab.org/system/images/photos/000/019/492/large/pm10gif.gif "pm10gif.gif")

- PM 2.5 configuration: _after fig 4.3 from the MiniVol manual_

![impactor assembly for PM2.5](https://publiclab.org/system/images/photos/000/020/092/large/IMG_20170404_161403_gif.gif "IMG_20170404_161403_gif.gif")
...
![image description](https://publiclab.org/system/images/photos/000/019/494/large/20170207_174826.jpg "20170207_174826.jpg")