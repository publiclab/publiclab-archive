...
<img width="500px" src="http://www.pbs.org/idealab/centerville.png" />

As a newcomer to Butte, Mont., and as a [grassroots mapper](http://grassrootsmapping.org/), I've learned a lot about a neighborhood's memories of itself, and the role that mapping can play in reasserting a human-scale sense of place. My experience here has since led to a collaboration between [Public Laboratory for Open Technology and Science](http://publiclaboratory.org/), of which I'm a founding member, and the National Affordable Housing Network, which is [engaged in redevelopment](http://mtstandard.com/news/local/centerville-neighborhood-among-targets-for-million-infusion/article_217dc50c-cd62-11e0-8d4a-001cc4c002e0.html) in Centerville. 

While mining still occurs in Butte, it's no longer central to the city's economic life. But it is, and will remain, the process that has most shaped the landscape. The future of this landscape has generated a conflict in identity between history and toxicity, cleanup and preservation. Butte has less than half the population it had during its boom years, but the population has stabilized, and more than 30,000 people still call it home. Very often, their memories of how people lived and worked with the landscape are often dwarfed by [post-mining battles](http://maps.google.com/maps?q=Meaderville,+Butte,+Silver+Bow,+Montana+59701&hl=en&geocode=FQU-vgIdLU5L-Q&hnear=Meaderville,+Butte,+Silver+Bow,+Montana&t=h&z=14&vpsrc=0) over controlling, preserving or changing the physical shape of Butte and involve local, state and federal agencies with overlapping concerns. 


The human element in these battles is often lost through the desire for institutionally measurable quantitative outcomes that can be evaluated at a distance. A community's desired outcomes aren't easily measured, and get sidelined during bureaucratic processes because they will not lead to measurable institutional outcomes comparable with other sites.

<a href="https://www.flickr.com/photos/14397636@N07/6084851154/" title="The Original Mine Yard, Butte, Montana by mathew.lippincott, on Flickr"><img src="https://farm7.staticflickr.com/6192/6084851154_e0356c5d02.jpg" width="500" height="369" alt="The Original Mine Yard, Butte, Montana"></a>

##Centerville##

The built environment of Butte is a result of workers arriving to inhabit temporary camps which later became neighborhoods around expanding mine sites on Butte's North hill. Many of the city's ethnic neighborhoods such as [Meaderville](http://maps.google.com/maps?q=Meaderville,+Butte,+Silver+Bow,+Montana+59701&hl=en&geocode=FQU-vgIdLU5L-Q&hnear=Meaderville,+Butte,+Silver+Bow,+Montana&t=h&z=14&vpsrc=0) and [Mcqueen](http://maps.google.com/maps?q=McQueen,+Butte,+Silver+Bow,+Montana+59701&hl=en&geocode=FQU-vgIdLU5L-Q&hnear=Meaderville,+Butte,+Silver+Bow,+Montana&t=h&z=14&vpsrc=0) were consumed in the process of mining the hill, but the Centerville neighborhood has prevailed. Centerville, which is 6,000-feet up and within miles of the continental divide, looks out across Butte, Summit Valley, and the Rockies. Mountains 30 miles away are visible on a clear day.

<a href="https://www.flickr.com/photos/14397636@N07/5983123343/" title="panorama of the mountain con mine by mathew.lippincott, on Flickr"><img src="https://farm7.staticflickr.com/6133/5983123343_cfebe16c7d.jpg" width="500" height="191" alt="panorama of the mountain con mine"></a>
...
[The Public Laboratory for Open Technology and Science](http://publiclaboratory.org/) has been supporting a grassroots campaign of redevelopment in Centerville that now involves coordinated efforts from HUD (U.S. Department of Housing and Urban Development), the USDA (U.S. Department of Agriculture) self-help program, Habitat for Humanity, and the National Affordable Housing Network through mapping.  

![marycarol](http://www.pbs.org/idealab/assets_c/2011/12/Mary%20Carol%20Wohman%27s%20home-thumb-500x230-2255.png)

##Meeting Centervillians##

I came to Butte with a few intentions: to see how a community-situated mapping project could help in housing and redevelopment, to refine my [bamboo, Tyvek, and tape techniques for kite building](http://publiclaboratory.org/notes/mathew/11-4-2011/towards-tyvek-bamboo-delta-kit), and to [lower the cost of aerial mapping](http://publiclaboratory.org/notes/mathew/11-4-2011/towards-tyvek-bamboo-delta-kit). Gene Wohlman noticed our early attempts to get kites in the air, and our frequent cursing of the wind. Gene runs an NOAA (National Oceanic and Atmospheric Administration) weather station, and kindly taught us when to expect wind in Butte. 
...
In July, with the help of Stephen Foreman from the [Butte-Silver Bow GIS office](http://co.silverbow.mt.us/departments/gis.asp), we made a 32"x48" map of just Centerville, from the most recent high-res airplane imagery (2004), and placed it in the Centerville volunteer fire department, and we provided colored stickers and sticky notes. Between neighborhood meetings at the VFW, Centerville residents marked abandoned buildings, unstable structures, fire damage, and debris around the neighborhood. By early September, these maps were used to coordinate dumpster locations with the city, and work days for debris removal for the residents.

<a href="https://www.flickr.com/photos/14397636@N07/6084854686/" title="Northwestern Centerville, Butte, MT.  Photo collage by mathew.lippincott, on Flickr"><img src="https://farm7.staticflickr.com/6066/6084854686_c840afc536.jpg" width="500" height="316" alt="Northwestern Centerville, Butte, MT.  Photo collage"></a>

##Defining a notion of place##

Beyond these measurable outcomes, the maps had a galvanizing effect on residents. As author and cartographer Denis Wood has [pointed out](http://books.google.com/books?id=_MV6GKPAgpoC&lpg=PP1&dq=rethinking%20the%20power%20of%20maps&pg=PA67#v=onepage&q&f=false), maps allow for a sort of political self portraiture, defining a notion of place within Cartesian space. 
