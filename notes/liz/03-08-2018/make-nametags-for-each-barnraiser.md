...
path: public/static/notes/liz/03-08-2018/make-nametags-for-each-barnraiser.md
uid: 7
...
* printer paper
* a printer
* The template (linked above and [here][2]) a layout program (Google Slides? Microsoft Word?) where you can layout 3"x4" squares
...
* once arrived, set up a Welcome table and lay them out
  ...
  [1]: https://publiclab.org/system/images/photos/000/023/912/large/Screen_Shot_2018-03-08_at_11.00.46_AM.png "Screen_Shot_2018-03-08_at_11.00.46_AM.png"
  [2]: https://docs.google.com/drawings/d/1IzHM4OiROFkzF8ig0HLFttedGB33wQsNA8JbhWUwua4/edit