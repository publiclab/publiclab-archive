...
From http://science.creativecommons.org/hardware/
...
The draft paper and presentation are embedded here: 
**http://science.creativecommons.org/hardware/workshop/**

NB: the paper is in draft format and is NOT CITABLE YET. 

Notes from the day are here (they should be embedded in the above URL soon): 
http://etherpad.creativecommons.org/p/openhardware
