...
CDOM/FDOM levels can be measured using [electrical optical sensors](https://www.abestmeter.com/electronic-water-level-switch/) that use fluorometers and sapphire lens. These sensors gauge the light availability in water bodies depending on the water level and indicate the concentration of dissolved organic matter (DOM).


#### 2\. Chlorophyll Fluorescence Analysis

![image description](https://publiclab.org/system/images/photos/000/022/854/large/dam-with-algae-growth.jpg "dam-with-algae-growth.jpg")

When the surface water in ponds and lakes is rich in minerals, namely phosphorus and nitrogen, algae flourish. Disproportionate growth of algae leads to oxygen depletion and increased levels of nitrogen and phosphorus which can be toxic to the flora and fauna.

[Chlorophyll fluorescence](https://www.scribd.com/document/341472527/T606-the-Basics-of-Chlorophyll-Measurement), measured using algae toximeters, indicates the percentage of wet-chemical chlorophyll and active chlorophyll in the water sample under illumination. This is an effective method to keep a check on the excessive algal growth and monitor the water quality.
...
![image description](https://publiclab.org/system/images/photos/000/022/857/large/Tds-Meter-Vpure-Water-Quality-Ro-Di-Water.jpg "Tds-Meter-Vpure-Water-Quality-Ro-Di-Water.jpg")

Conductivity, salinity, and TDS meters analyze the water quality by measuring the specific electrical conductance of electrolytes dissolved in the water. Though each of these instruments measures a separate parameter, the results are correlated and indicative of pollution.
...
![image description](https://publiclab.org/system/images/photos/000/022/858/large/Thermoelement-Thermometer_Omega.jpg "Thermoelement-Thermometer_Omega.jpg")

Several devices such as thermometers, thermistors, thermocouples, and [digital temperature sensors](https://publiclab.org/notes/donblair/08-25-2015/dock-test) are used to obtain temperature readings at varying depths, time, and locations.
...
![image description](https://publiclab.org/system/images/photos/000/022/861/large/total_suspended_solids.jpg "total_suspended_solids.jpg")

The solar radiation provides light, heat, and energy to all living being on earth. Low or high levels of ultraviolet radiations can halt the photosynthetic process, causing permanent damage to the aquatic ecosystem.
...
A sudden increase in the turbidity and the total suspended solids (TSS) is an indicator of soil erosion and [point-source pollution](https://oceanservice.noaa.gov/education/kits/pollution/03pointsource.html) adding heavy metals and effluents into the water.
...
![image description](https://publiclab.org/system/images/photos/000/022/860/large/measure_water_clarity_by_secchi_disk.jpg "measure_water_clarity_by_secchi_disk.jpg")

The Secchi disk is often lowered in a water body to measure the depth until which it is no longer visible (also referred to as the Secchi depth). This is a measure of the cloudiness of the water.

These devices help measure the water clarity and [photosynthetically active radiation](https://en.wikipedia.org/wiki/Photosynthetically_active_radiation) (PAR), promoting a healthy environment for the plants and animals residing in the water body.
...
1. Iperovich's insightful research on [faster-waterproofed temperature sensors](https://publiclab.org/notes/lperovich/07-07-2015/thermal-fishing-bob-faster-waterproofed-temperature-sensors)
2. [Accuracy of long thermistors](https://publiclab.org/notes/kgrevera/08-22-2015/long-thermistor-test)
3. [Policies for Tackling agricultural water pollution](https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/663456/farming-rules-water-consult-sum-resp.pdf) in England
4. [Department for](https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/307788/river-basin-planning-standards.pdf)[Environment Food and Rural Affairs standards](https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/307788/river-basin-planning-standards.pdf) to protect the water environment
5. [Water quality assessment of lake water: a review](https://link.springer.com/article/10.1007/s40899-015-0014-7)