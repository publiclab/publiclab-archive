...
path: public/static/notes/vaibhavgeek/04-01-2017/omniauth-and-wiki-discussion.md
uid: 504058
...
LinkedIn: [https://www.linkedin.com/in/vaibhav-maheswhari-407aaa88/](https://www.linkedin.com/in/vaibhav-maheswhari-407aaa88/)
...
- [https://github.com/vaibhavgeek/friendyoke](https://github.com/vaibhavgeek/friendyoke): Friendyoke was a social networking website which enabled people to connect with each other. I made this website in the year 2008, at that time in India, facebook was still gaining traction and other social networking websites were not even known. This website was built on top of [ASP.NET](http://asp.net/), C# and Telerik Tools.
...
I have cloned the repository on my github account ([https://github.com/vaibhavgeek/plots2/](https://github.com/vaibhavgeek/plots2/)). I have not set it up on any cloud service but I have set it up locally and it seems running fine on the local server.
...
([https://github.com/publiclab/plots2/pull/1350](https://github.com/publiclab/plots2/pull/1350)) 

# Experience

I have worked on 4 to 5 Ruby on Rails projects till now (~ 2 years of experience in Rails) which were similar to what Public Lab would require in this project. You can have a look at those projects on my github profile. My project [edunova.io](http://edunova.io/) had been selected by Government of India to be showcased at Digital India Expo held at New Delhi, India. It won a cash prize of 1543.05 dollars there. I am highly motivated towards projects of social cause such as education, healthcare and climate change.
