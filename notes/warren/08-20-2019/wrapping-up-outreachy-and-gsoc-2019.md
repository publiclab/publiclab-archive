...
(above, see a list of folks who've made first-timer-only issues [on our code Welcome Page](https://code.publiclab.org/#r=all), by Rishabh!)
...
Building on [some notes I wrote a couple years ago](https://publiclab.org/notes/warren/09-07-2017/wrapping-up-google-summer-of-code-2017-at-public-lab#1.+Turn+your+remaining+work+into+well-documented+onramps+for+new+contributors) at this time, I wanted to share some advice on wrapping up your projects.
...
1. READMEs are a great place for any final documentation - showing how to use your project, either for developers or for users.
2. Demos are great, especially if you're developing a self-contained library! Be sure people can see your code running, for example in a [GitHub Pages](https://pages.github.com/) demo! See this one for example: [https://publiclab.github.io/PublicLab.Editor/examples/](https://publiclab.github.io/PublicLab.Editor/examples/)
3. If there are critical tasks or milestones, prioritize these of course!
4. If you have "nice-to-have" features you think would be great, but aren't critical, turn them into well-documented issues to circle back to later. Maybe someone else will pick them up as well! Leave thorough notes to lines of code etc.
5. A wrap-up post like this one on [Leaflet Environmental Layers](https://publiclab.org/notes/sagarpreet/06-06-2018/leaflet-environmental-layer-library) or this one [on Image Sequencer](https://publiclab.org/notes/ccpandhare/08-23-2017/gsoc-2017-final-work-product-of-image-sequencer-project) is a great way to provide a walkthrough of your work to others, and helps mentors do a good evaluation. It's OK if they're a bit redundant with a README or with your issues - they serve a different purpose!
