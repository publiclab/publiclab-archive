...
I put up this call for input on a [collaboratively-written Pocket Guide to Grassroots Mapping](https://publiclab.org/notes/warren/07-01-2017/collaboratively-write-the-new-pocket-guide-to-grassroots-mapping) last week, and you might notice that the end of the booklet is a set of "logbook entry forms" that (for now) look like this:

  
![image description](https://publiclab.org/system/images/photos/000/021/019/large/Screen_Shot_2017-07-05_at_4.16.19_PM.png "Screen_Shot_2017-07-05_at_4.16.19_PM.png")
