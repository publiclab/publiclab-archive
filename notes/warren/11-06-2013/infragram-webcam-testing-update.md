...
Once we hash out the details of the order, we're going to give them the go-ahead to start production, and will post some updates as we know the final schedule. Fingers crossed!