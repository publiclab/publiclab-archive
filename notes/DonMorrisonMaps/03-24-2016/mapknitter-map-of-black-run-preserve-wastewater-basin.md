...
<iframe src="https://mapknitter.org/embed/black-run-preserve-south-wastewater-basin" style="border:none" width="100%" height="400px"></iframe><br /><br />A decommissioned treated wastewater basin that is being restored to native habitat. Images taken from scratch built quad H copter with Pixhawk flight controller. Altitude 50m AGL. <br />https://mapknitter.org/embed/black-run-preserve-south-wastewater-basin