...
In embedded systems, software commonly referred to as firmware is hidden inside an equivalent hardware instead of in another hardware. Basically embedded systems are task specific devices. one among its most vital characteristic is gives the output within the time constraints otherwise you can say they're time bound systems. 
