...
path: public/static/notes/ethanbass/02-23-2016/the-effect-of-dilution-on-the-emission-spectrum-of-diesel-fuel.md
uid: 46902
...
My data set can be viewed [here](https://spectralworkbench.org/sets/2724). I found that the neat diesel fuel had a red shifted and spectrally broadened emission spectrum in comparison with the most dilute sample tested (containing 5 drops of diesel in ~ 1 ml of mineral oil or ~1:5). With the exception of [a single outlier](https://spectralworkbench.org/spectrums/61261), the spectra shift monotonically to the right with each increase in diesel concentration across the whole set (after equalizing either by area or by height).

This general trend is in good agreement with the published literature. The figure below, reproduced in [Analysis of Crude Petroleum Oils Using Fluorescence Spectroscopy (Reviews in Fluorescence 2005)](http://link.springer.com/chapter/10.1007%2F0-387-23690-2_8) shows the spectral shifting that occurs in a lighter and a heavier grade of crude oil at various dilution factors.


[![Screen_Shot_2016-02-23_at_1.53.23_AM_copy.jpg](//i.publiclab.org/system/images/photos/000/014/516/medium/Screen_Shot_2016-02-23_at_1.53.23_AM_copy.jpg)](//i.publiclab.org/system/images/photos/000/014/516/original/Screen_Shot_2016-02-23_at_1.53.23_AM_copy.jpg)


This shifting of the emission profile is generally attributed to “collisional energy transfer” — the process whereby an excited molecule transfers energy to a larger molecule by colliding with it, which then causes it to fluorescence [Visible and Near-Infrared Fluorescence of Crude Oils](https://www.researchgate.net/publication/248337600_Visible_and_Near-Infrared_Fluorescence_of_Crude_Oils).
