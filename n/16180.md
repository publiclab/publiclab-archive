...
<p>Redirecting to: <a href='/notes/warren/04-20-2018/prepare-an-sd-card-for-a-raspberry-pi-camera-from-scratch'>Prepare an SD card for a Raspberry Pi camera from scratch</a></p><script>window.location.replace('/notes/warren/04-20-2018/prepare-an-sd-card-for-a-raspberry-pi-camera-from-scratch');</script>