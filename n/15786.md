...
<p>Redirecting to: <a href='/notes/imvec/02-20-2018/proofmode-open-camera'>Proofmode + Open Camera</a></p><script>window.location.replace('/notes/imvec/02-20-2018/proofmode-open-camera');</script>