...
<b>On this page:</b>
<ul>
<li><a href="https://publiclab.org/wiki/basics#How+do+I+join+Public+Lab?">How do I join Public Lab?</a></li>
<li><a href="https://publiclab.org/wiki/basics#Why+ask+questions+on+Public+Lab?">Why ask questions on Public Lab?</a></li>
<li><a href="https://publiclab.org/wiki/basics#How+do+I+do+Public+Lab+stuff+near+me?">How do I do Public Lab stuff near me?</a></li>
<li><a href="https://publiclab.org/wiki/basics#Who+else+is+doing+what+I">Who else is doing what I’m doing?</a></li>
<li><a href="https://publiclab.org/wiki/basics#How+do+I+contribute+or+collaborate+at+Public+Lab?">How do I contribute or collaborate at Public Lab?</a></li>
<li><a href="https://publiclab.org/wiki/basics#Where+can+I+find+information+on+methods+and+tools?">Where can I find information on methods and tools?</a></li>
<li><a href="https://publiclab.org/wiki/basics#Where+can+I+get+a+kit+or+equipment+for+environmental+monitoring?">Where can I get a kit or equipment for environmental monitoring?</a></li>
<li><a href="https://publiclab.org/wiki/basics#How+do+I+use+the+Public+Lab+website?">How do I use the Public Lab website?</a></li>
<li><a href="https://publiclab.org/wiki/basics#What+is+community+science?">What is community science?</a></li>
<li><a href="https://publiclab.org/wiki/basics#What+other+things+might+help+when+getting+started+with+Public+Lab?">​​What other things might help when getting started with Public Lab?</a></li>
</ul>
</div>
...
Check out our [Question and Answer system here](/questions), and [post your own question here](https://publiclab.org/questions/new?title=&tags=question%3Ageneral&template=question&redirect=question). For more information on how to post questions and why they're a great way to get involved, visit our page [About Public Lab Questions & Answers](/wiki/public-lab-q-and-a).
...
We organize questions and information on this website under topic areas, like air quality, land use, law and policy, and many more. People asking questions or doing work related to a particular topic make up a topic-based community. These topics are represented by words and short phrases called ‘tags’, which connect content on PublicLab.org. Find your topic of interest and people in the topic-based community by [browsing the tag pages](/tags), or from the [Topics](/topics) wiki page. 
...
If you’re new to Public Lab, you can find out more about using the website on our [Website Basics](/website-basics) wiki page. There’s information on the website’s purpose, its major areas, and kinds of pages. You can also find more information about posting for the first time at our [First-Time Posters](/first-time-poster) wiki page. For more information on key features of the website and a directory to website-related resources, visit [How to use and improve this website](/website). 
