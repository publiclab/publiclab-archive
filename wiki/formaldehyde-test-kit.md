...
**Table of contents** | 
--------------------|---------------------
[Goals](/wiki/formaldehyde-test-kit#Goals) | The goals of formaldehyde testing
[What data should we collect?](/wiki/formaldehyde-test-kit#What+data+should+we+collect?) | data we'd like to know about formaldehyde and its sources
[Electronic Monitoring](/wiki/formaldehyde-test-kit#Electronic+Monitoring) | electronic sensors for formaldehyde detection
[Chemical-reaction-based testing](/wiki/formaldehyde-test-kit#Chemical-reaction-based+testing) | prepared reactions either for lab testing or field testing
[from published method to a DIY test](/wiki/formaldehyde-test-kit#from+published+method+to+a+DIY+test) | moving from a published reaction test to a DIY kit & development needs
[Calibrating Flow](/wiki/formaldehyde-test-kit#Calibrating+Flow) | calibrating an aquarium pump for use with single use formaldehyde testing tubes
[data recording & verification](/wiki/formaldehyde-test-kit#data+recording+&+verification) | how are we going to verify that we collected the data?
[DIY kit](/wiki/formaldehyde-test-kit#DIY+kit) | parts in a low-cost DIY formaldehyde testing kit
[Assembly](/wiki/formaldehyde-test-kit#Assembly) | assembling and calibrating a DIY kit 
[Lending Library Kit](/wiki/formaldehyde-test-kit#Lending+Library+Kit) | designing a ruggedized kit for heavy field work and borrowing
...
[![wood-types-2.png](https://i.publiclab.org/system/images/photos/000/011/236/medium/wood-types-2.png)](https://i.publiclab.org/system/images/photos/000/011/236/original/wood-types-2.png)

_particle board, mdf, hdf, hardboard, and plywood may all release formaldehyde -image @warren_
...
* _optional filter for protecting the pump-- recommended_
...
###Filters for reliability (optional but recommended)
...
<iframe width="420" height="315" src="https://www.youtube.com/embed/Hc5bHusk5FI" frameborder="0" allowfullscreen></iframe>
