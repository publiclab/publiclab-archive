...
nid: 20050
title: Datasource
path: public/static/wiki/datasource.md
uid: 7
...
Environmental Exposome|Public Health Exposome provides a systems approach designed to capture the totality of one’s exposures across the lifespan from conception to death.|http://communitymappingforhealthequity.org/environmental-data/
