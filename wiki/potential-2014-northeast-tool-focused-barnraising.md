...
**Friday, June 6 -- Homebase, Tidmarsh Farm**
...
Prepare Riffles for testing
Test tools & gather data: tow riffles and measure temperature and mark GPS
Review data, document findings

_--Workshop B--_
Toolset Workshop: Thermal fishing bob 
Prepare Thermal fishing bobs for testing
Test tools & gather data: tow thermal fishing bobs in water
Review data, document findings

_--Workshop C--_
Toolset Workshop: Oil Testing & Spectroscopy
Gather samples from the site
Test samples & document data
...
Prepare kites and camera for testing
Test tools & gather data: fly camera and infrared cameras over site


##Sign-up form
Please fill out the required information on this [form](https://docs.google.com/forms/d/1UZksk-spkzeSDAwWluHU8Dbmr1OsmKED3Zf2H6CIrmc/viewform?usp=send_form). Before we move forward, we need to collect information about how many people plan on attending and what kind of accommodations are needed. 
...
[![plymouth.jpg](https://i.publiclab.org/system/images/photos/000/003/789/medium/plymouth.jpg)](https://i.publiclab.org/system/images/photos/000/003/789/original/plymouth.jpg)
