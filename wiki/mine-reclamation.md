...
This wiki serves to collect projects, methods, research, and questions related to mine reclamation. Help this resource grow by editing this page [here](https://publiclab.org/wiki/edit/mine-reclamation?t=1647283114)! Visit the [mine reclamation tag page](https://publiclab.org/tag/mine-reclamation) to see the latest posts about this topic on Public Lab, and receive updates by following the #mine-reclamation tag:

<a class="btn btn-primary btn-lg" href="https://publiclab.org/subscribe/tag/mine-reclamation">Follow mine reclamation</a>

_Lead image: ["Reclaimed Mine Area_DSC_0168"](https://www.flickr.com/photos/107640324@N05/22552201357) by [Intermountain Region US Forest Service](https://www.flickr.com/photos/107640324@N05) is marked with [CC PDM 1.0](https://creativecommons.org/publicdomain/mark/1.0/?ref=openverse)._

<div class="alert alert-info" role="ToC">
<b>What’s on this page:</b>
<br>
<ul>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Community+stories+and+projects">Community stories and projects</a></li>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Questions+about+mine+reclamation">Questions</a> about mine reclamation</li>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Methods+and+activities+on+monitoring+reclamation">Methods and activities</a> on monitoring reclamation</li>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Regulations+on+mine+reclamation">Regulations</a> on mine reclamation</li>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Advocacy">Advocacy</a></li>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Holistic+Remediation">Holistic remediation</a> info and resources</li>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Environmental+&+Health+Concerns">Environmental and human health concerns</a> related to mine reclamation efforts</li>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Further+reading+and+resources">Further reading and resources</a></li>
<li><a href="https://publiclab.org/wiki/mine-reclamation#Next+step+challenges">Next step challenges</a></li>
</div>
...
[nodes:grid:project:mine-reclamation]
...
+ “[The Indigenous Exchange Forum: transitions in mine closure](https://csrm.uq.edu.au/publications/the-indigenous-exchange-forum-transitions-in-mine-closure)” was a convening and report that “aim[ed] to facilitate knowledge exchange and to share innovative ideas and practices in response to mine site transitions between the First Nations groups, and between First Nations groups and industry.” 
+ [MiningWatch Canada](https://miningwatch.ca/): 
     + “[New Map Shows Dozens of Mine Pollution Threats in BC](https://miningwatch.ca/news/2021/1/19/new-map-shows-dozens-mine-pollution-threats-bc)”
...
<i>Please make sure to monitor at locations that are safe and accessible to the public. Do not trespass on private property!</i>
</div>
...
[nodes:grid:mine-reclamation-photography]
...
<img style="width: 70%; height: 70%" src="https://publiclab.org/i/45529?s=o
" alt="Acid mine drainage from the Mike Horse Mine complex enters upper Blackfoot River watershed">

_Image: “Acid mine drainage from the Mike Horse Mine complex enters upper Blackfoot River watershed,” [Earthworks](https://www.flickr.com/photos/33246316@N02/30152881208), [CC BY](https://creativecommons.org/licenses/by/2.0/)._
...
+ Methods for monitoring conductivity documented on Public Lab: [https://publiclab.org/methods#conductivity](https://publiclab.org/methods#conductivity)
...
The soil contamination wiki at [https://publiclab.org/wiki/soil](https://publiclab.org/wiki/soil) is where we’ve collected and organized information on soil contaminants and testing methods. Below are some resources that might be particularly useful in monitoring or evaluating mine reclamation. 

[nodes:grid:mine-soil-health]
...
[Different federal agencies](https://www.epa.gov/smartsectors/mining-sector-information) are involved in regulating mining activity and reclamation in the US

+ The [Office of Surface Mining Reclamation and Enforcement (OSMRE)](https://www.osmre.gov/) regulates coal mining and regulation in the US, operating under the 1977 Surface Mining Control and Reclamation Act (SMCRA). 
...
+ In many cases, regulatory activities are delegated to individual states or tribes. [List of state mining agencies in the US](https://www.msha.gov/support-resources/external-mining-resources/state-mining-agencies). 
...
+ [Water: Common Permit Violations](https://publiclab.org/notes/ekpeterman/01-20-2022/common-permit-violations-water)
+ [Ground: Common Permit Violations](https://publiclab.org/notes/ekpeterman/02-15-2022/ground-common-permit-violations)
+ [Videos on permit violations](https://publiclab.org/wiki/the-mountains-and-mines-monitoring-project#Project+Outputs:+Learn+about+observable+permit+violations+for+coal+mining+with+the+materials+below)

<br>

#### Abandoned mines

Many mines and surrounding lands that have since been abandoned by mine operators remain  inadequately reclaimed. The Bureau of Land Management estimates that there are 100,000 to 500,000 [abandoned mines](https://www.abandonedmines.gov/about_abandoned_mines) in the western US alone, the location of most unrecorded. This poses massive public health, safety, and environmental hazards ([publication about abandoned mine safety in CA](https://www.conservation.ca.gov/dmr/abandoned_mine_lands/Documents/Safety%20at%20Old%20Mines.pdf)). Tailings piles likely contain harmful chemicals which may leach into the soil, groundwater, and surrounding surface water, especially when left unmanaged at an abandoned site ([source](https://science.howstuffworks.com/engineering/structural/abandoned-mine.htm)).

The OSMRE runs the Abandoned Mine Land (AML) program to help fund state- and tribe-led reclamation of abandoned coal mines. The Department of the Interior recently extended this program through 2034 ([source](https://thehill.com/policy/energy-environment/589590-interior-department-extends-abandoned-mine-reclamation-program)).

<br>

### Australia 

+ Recent legislation passed in the state of Queensland has elevated the importance of mine reclamation. Mining applications must have separate operating and reclamation plans; specifically, “[Progressive Rehabilitation and Closure Plans (PRCP)](https://environment.des.qld.gov.au/__data/assets/pdf_file/0035/87659/mined-land-rehabilitation-policy.pdf)” are required for site-specific mines. The state also [created a new “Rehabilitation Commissioner”](https://www.qrc.org.au/media-releases/qrc-welcomes-new-rehabilitation-commissioner-for-mining-sector/) position to oversee reclamation work. 
...
[nodes:grid:mine-reclamation-advocacy]
...
Mine reclamation is often seen as a bandaid -- an opportunity to fix the damage done to a landscape during the mining process. However, reclamation is a part of the mining process and can itself cause harm by altering the landscape further and ignoring or contributing to past injustices. A holistic approach to reclamation/remediation includes principles such as emphasizing public participation, elevating & addressing environmental justice concerns, and acknowledging a landscape’s “thickness” — the “diversity of past and contemporary values projected onto the landscape, history, meaning, and social interactions with and on the landscape ([Rethinking remediation](https://research.library.mun.ca/13771/1/Rethinking%20remediation_LocalEnvironment_Accepted.pdf)). Below are a few resources shared by holistic mine reclamation scholar Caitlynn Beckett:

+ [The Social Aspects of Mine Closure Research Consortium](https://www.mineclosure.net/) - research group out of Queensland, Australia developing solutions to the sustainability challenges of the mining industry.
+ [Advocacy work pertaining to the Giant Mine in Canada](https://www.mineclosure.net/)
+ [Unearthing Justice](https://btlbooks.com/book/unearthing-justice) – a book on protecting your local community from the mining industry
+ [Post-Industrial Landscape Scars](https://link.springer.com/book/10.1057/9781137025999) – a book on the budding research area of “industrial heritage”
+ [The River Is in Us](https://www.upress.umn.edu/book-division/books/the-river-is-in-us) - a book about how an indigenous Mohawk community in New York state fought back against contamination of its lands 
+ [Violence on the Land, Violence on Our Bodies: Building an Indigenous Response to Environmental Violence](http://landbodydefense.org/uploads/files/VLVBReportToolkit2016.pdf) - a toolkit produced from an initiative shared by the Women’s Earth Alliance and Native Sexual Health Network to document ways the North American indigenous women’s safety and health are impacted by extractive industries and support resistance to environmental violence 
...
+ Beckett C. and Keeling A. 2018. [Rethinking remediation: Mine reclamation, environmental justice, and relations of care](https://research.library.mun.ca/13771/1/Rethinking%20remediation_LocalEnvironment_Accepted.pdf). _Local Environment_, 24:3, 216-230. PDF here. 
+ Kuter, N., 2013, '[Reclamation of Degraded Landscapes due to Opencast Mining](https://www.intechopen.com/chapters/45415)', in M. Özyavuz (ed.), _Advances in Landscape Architecture_, IntechOpen, London. 10.5772/55796. 
+ Wei X, Wei H, Viadero RC Jr. 2010. [Post-reclamation water quality trend in a Mid-Appalachian watershed of abandoned mine lands](https://doi.org/10.1016/j.scitotenv.2010.11.030). _Sci Total Environ_, 409(5):941-8. 
...
+ Identify advocacy pathways that include [federal regulations or enforcement](https://publiclab.org/questions/bhamster/02-10-2022/is-there-federal-level-recourse-that-communities-can-take-when-mine-reclamation-is-not-being-done-properly), especially when state regulations result in inadequate reclamation.
+ Policy reform that invites more public participation in reclamation planning and throughout mine operations. (This [report](https://research.library.mun.ca/14487/) by Beckett et al. reviewed a sample of reclamation programs in different countries and found few examples of successful public engagement with reclamation.)
+ Develop and test methods for community scientists to use landsat imagery (satellite images of Earth from space) to do remote monitoring of surface mining and reclamation over time ([example here](https://sites.tufts.edu/gis/files/2013/11/Nally_Dan_2.pdf)). 
+ Research and develop sensor networks for monitoring soil and water quality around mining sites, to detect potential pollution in real-time ([similar example for agricultural applications](https://www.sciencedirect.com/science/article/pii/S2210784316302042)).
