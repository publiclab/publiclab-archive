...
_Lead image: Gas Chromatography-Mass Spectrometry facility. [Idaho National Laboratory](https://www.flickr.com/photos/30369883@N03/32652828165), [CC BY](https://creativecommons.org/licenses/by/2.0/)._ 
...
<br>
<ul>
<li><a href="https://publiclab.org/wiki/air-lab-testing#How+will+the+lab+analyze+your+air+sample?" class="alert-link">What the lab will do</a> with your sample</li>
<li><a href="https://publiclab.org/wiki/air-lab-testing#Finding+an+environmental+lab+to+analyze+your+sample" class="alert-link">A list of labs</a> that can analyze air samples, and what kinds of <a href="https://publiclab.org/wiki/air-lab-testing#Questions+to+ask+the+testing+lab" class="alert-link">questions to ask</a> to ensure the lab is a good match for your project</li>
<li><a href="https://publiclab.org/wiki/air-lab-testing#Other+preparation+and+considerations" class="alert-link">Additional preparation</a> to consider before you send in a sample</li>
<li>What you can do after getting your <a href="https://publiclab.org/wiki/air-lab-testing#Getting+your+lab+results+back" class="alert-link">lab results</a> back</li>
<li><a href="https://publiclab.org/wiki/air-lab-testing#Community+questions+about+air+sample+analysis" class="alert-link">Community questions</a>  about air sample analysis</li>
</ul>
</div>
<br>
...
_If you know of additional commercial, university, or other labs that can analyze samples in Tedlar bags, please [edit this wiki](https://publiclab.org/wiki/edit/air-lab-testing) and add it to the table!_
<br>
<br>
...
_Do you have any other tips or experiences to share for air sample analysis? Please [edit this wiki](https://publiclab.org/wiki/edit/air-lab-testing) page or [post a research note](https://publiclab.org/post?tags=air-sampling,air-lab-testing)!_
