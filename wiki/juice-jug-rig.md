...
This guide shows how to make a protective case large enough for [two synchronized cameras](/wiki/dual-camera-kit-guide), when you are taking [infrared and regular photos](/tool/near-infrared-camera) from a [balloon mapping](/tool/balloon-mapping) setup.

This guide has been moved to:

> https://publiclab.org/notes/warren/02-21-2017/build-a-juice-bottle-based-rig-to-carry-two-cameras