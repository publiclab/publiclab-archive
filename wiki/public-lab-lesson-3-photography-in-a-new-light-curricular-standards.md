...
path: public/static/wiki/public-lab-lesson-3-photography-in-a-new-light-curricular-standards.md
uid: 4
...
[Louisiana Academic Standards (Middle School)](http://www.louisianabelieves.com/docs/academic-standards/standards---k-12-science.pdf?sfvrsn=2)
...
Use computers and/or calculators to analyze and interpret quantitative data (SI-MA3)
...
Recognize that there may be more than one way to interpret a given set of data,
which can result in alternative scientific explanations and predictions (SI-M-A6)
...
Identify areas in which technology has changed human lives (e.g., transportation,
...
Students develop spatial understanding through the study of location, distance, direction, pattern, shape, and arrangement
...
Cite examples of scientific advances and emerging technologies and how they affect
	society (e.g., MRI, DNA in forensics) (SI-H-B3)
...
Evaluate how different media affect the properties of reflection, refraction, diffraction, 
