...
<div class="alert alert-warning">This post, originally by @akshaya and @kanarinka, is being reposted from this wiki page to <a href="https://publiclab.org/notes/ashkaya/09-17-2016/build-a-coqui-a-simple-water-conductivity-sensor">this Activity</a> in order to integrate with the new activities system.</div>

You can find more about the Coqui and activities you can do with it here:
