...
enero 25-30 - Exposicion, fiesta. Discutir valor del projecto, lo que paso bien y no, y organiza projectos de mapas en otros comunidades. Tambien discutir la posibilidad de repetir algunos de estos projectos en 6 meses o 1 ano para mantener los datos de la mapa.

Notes from talking with Leo Burd:

Look at Young Activists Network

Voting on what kids want to do…

Organize an event vs. confrontational activism

connect kids with organizations, artists, etc. with whom they can work

PLAY NEIGHBORHOOD instead of house

warcraft as a fantasy version of a neighborhood gives kids SPACE to talk about issues

stickers to annotate a map
